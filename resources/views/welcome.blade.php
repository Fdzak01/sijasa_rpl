...
<body>
    ...
    <section class="relative min-h-screen min-w-7xl">
        ...
        <div class="relative flex flex-col justify-center min-h-screen z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex">
                <img src="{{ asset('assets/users/img/SIJASA 1.png') }}" alt="logo" class="h-" />
                <h1 class="mb-5 text-5xl font-bold max-w-7xl text-gray-300">
                    SIJASA
                </h1>
            </div>
            <div class="">
                <h1 class="text-4xl lg:text-5xl font-bold mb-4 text-gray-300">
                    Butuh Bantuan?
                </h1>
                <h1 class="text-4xl lg:text-5xl font-bold mb-4 text-white">
                    Temukan jasa terbaik disini!
                </h1>
                <input type="text" placeholder="Cari Layanan..."
                    class="w-full max-w-3xl px-4 py-2 bg-white bg-opacity-50 rounded-box shadow-md focus:outline-none focus:ring-2 focus:ring-teal-600" />
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto flex flex-col items-center max-w-7xl">
                ...
                <div class="grid grid-cols-5 gap-12">
                    ...
                    @foreach ($kategori as $item)
                        <div class="flex flex-col items-center space-y-2">
                            <div class="p-4 bg-teal-600 rounded-lg text-white">
                                <img src="{{ asset('storage/' . $item->icon) }}" alt="">
                            </div>
                            <span class="text-gray-700 font-medium">{{ $item->kategori }}</span>
                        </div>
                    @endforeach
    ...
    <!-- About Section -->
    <section class="h-auto grid grid-cols-2">
        <!-- Gambar -->
        <div class="flex items-center justify-center">
            <img src="{{ asset('assets/users/img/Photo by Campaign Creators on Unsplash 1.png') }}" alt="Tentang Kami"
                class="h-auto max-w-full rounded shadow-lg" />
        </div>
        <!-- Teks -->
        <div class="bg-[#2FA29D] text-white flex flex-col justify-center px-16">
            <h2 class="text-4xl font-bold mb-6">Tentang Kami</h2>
            <p class="text-lg leading-relaxed">
                Platform yang mempermudah aktivitas sehari-hari dengan mempertemukan
                pengguna dan penyedia jasa secara aman, efisien, dan terpercaya.
                Platform yang mempermudah aktivitas sehari-hari dengan mempertemukan
                pengguna dan penyedia jasa secara aman, efisien, dan terpercaya.
            </p>
        </div>
