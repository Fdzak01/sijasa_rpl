...
<body>
    ...
    <div class="min-h-screen bg-base-200 flex items-center justify-center">
        <div class="grid grid-cols-2 w-full h-full">
            <!-- Bagian Kiri -->
            <div class="flex flex-col items-center justify-center space-y-6 bg-base-200">
                <h1 class="text-5xl font-bold text-teal-600">{{ Auth::user()->name }}</h1>
                <div class="flex items-center space-x-4">
                    <span class="text-lg font-medium">User</span>
                    <a href="/logout" class="text-teal-600 hover:underline">Keluar</a>
                </div>
                <img src="{{ asset('assets/admin/img/profile-img.png') }}" alt="User Image"
                ...
                <div class="w-3/4 p-6 bg-white rounded-lg shadow-md">
                    <div class="flex items-center space-x-4 mb-4">
                        <div class="bg-teal-600 p-3 rounded-full">
                            <svg width="24" height="24" viewBox="0 0 49 47" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="text-white">
                                <path
                                    d="M46.114 44.875V40.125C46.114 37.6054 44.9539 35.1891 42.8891 33.4075C40.8243 31.6259 38.0237 30.625 35.1036 30.625H13.0829C10.1627 30.625 7.36221 31.6259 5.29737 33.4075C3.23253 35.1891 2.07251 37.6054 2.07251 40.125V44.875M35.1036 11.625C35.1036 16.8717 30.1741 21.125 24.0932 21.125C18.0124 21.125 13.0829 16.8717 13.0829 11.625C13.0829 6.37829 18.0124 2.125 24.0932 2.125C30.1741 2.125 35.1036 6.37829 35.1036 11.625Z"
                                    stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <span class="text-teal-600 text-xl font-semibold">Personal Information</span>
                    </div>
                    <div class="space-y-4 text-gray-700">
                        ...
                        <p><span class="font-medium">Biografi:</span> {{ Auth::user()->bio }}</p>
                    </div>
                </div>
            </div>
        </div>
